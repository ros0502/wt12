...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <!-- Navigationslinks, links ausgerichtet -->
        <p>
        ...
        <!-- Chat Window, links ausgerichtet -->
        ...
        <!-- Nachrichtenformular, links ausgerichtet -->
        ...
        <style>
            ...
            #sendButton,
            #messageInput {
                height: calc(1.5em + 0.75rem + 2px); /* Standardhöhe von Bootstrap-Eingabefeldern */
            }
        </style>
